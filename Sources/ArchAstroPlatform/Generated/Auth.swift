...
public final class AuthClient: Sendable {
    ...
    /// HTTP 204 on success.
    public func requestRegisterMagicLink(alias: String? = nil, email: String? = nil, fullName: String? = nil, redirectUri: String? = nil, setOrg: String? = nil, timezone: String? = nil) async throws -> JSONValue {
        var body: [String: JSONValue] = [:]
        if let alias = alias {
            body["alias"] = .string(alias)
        }
    ...
    public func requestMagicLink(email: String? = nil, redirectUri: String? = nil, setOrg: String? = nil) async throws -> JSONValue {
        var body: [String: JSONValue] = [:]
        if let email = email {
            body["email"] = .string(email)
        }

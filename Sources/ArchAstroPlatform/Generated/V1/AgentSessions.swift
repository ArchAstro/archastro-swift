...
public final class AgentSessionResource: Sendable {
    ...
    ///
    /// - Parameters:
    ///   - agentSession: ID of the agent session to stream.
    /// - Returns: Server-Sent Events stream
    public func stream(agentSession: String) -> AsyncThrowingStream<SSEEvent, any Error> {
        return http.streamSSE("/api/v1/agent_sessions/\(agentSession)/stream")
    }
}

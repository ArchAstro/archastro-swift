...
public struct LinkListResponseDataItem: Codable, Sendable {
...
/// Successful response
public struct LinkListResponse: Codable, Sendable {
    public var afterCursor: String?
    public var beforeCursor: String?
    public var data: [LinkListResponseDataItem]
    public var hasMore: Bool

    public init(
        afterCursor: String? = nil,
        beforeCursor: String? = nil,
        data: [LinkListResponseDataItem],
        hasMore: Bool
    ) {
        self.afterCursor = afterCursor
        self.beforeCursor = beforeCursor
...
public final class LinkResource: Sendable {
    ...
    ///   - afterCursor: Opaque cursor returned by the previous page.
    /// - Returns: Successful response
    public func list(task: String, team: String? = nil, user: String? = nil, agent: String? = nil, org: String? = nil, limit: Int? = nil, afterCursor: String? = nil) async throws -> LinkListResponse {
        var query: [(String, String)] = []
        if let team = team {
            query.append(("team", team))
        }
        ...
        return try await http.request("/api/v1/tasks/\(task)/links", query: query)
    }
    ...
    public func create(task: String, input: LinkCreateInput) async throws -> TaskExternalLink {

...
public struct SolutionInstallInputAclAddItem: Codable, Sendable {
...
public struct SolutionInstallInputAclGrantsItem: Codable, Sendable {
    /// Array of action strings the principal is permitted to perform, e.g. `["read", "write"]`. Must contain at least one entry.
    public var actions: [String]
    /// The identifier of the principal. A string ID for `"user"`, `"team"`, `"org"`, and `"agent"` types; one of `"admin"`, `"member"`, or `"viewer"` for `"org_role"`; omit entirely when `principal_type` is `"everyone"`.
    public var principal: String?
...
public struct SolutionInstallInputAclRemoveItem: Codable, Sendable {
...
public struct SolutionInstallInputAcl: Codable, Sendable {
    /// Patch mode: grants to add or merge into the existing list. Cannot be combined with `grants`.
    public var add: [SolutionInstallInputAclAddItem]?
    ...
    public var grants: [SolutionInstallInputAclGrantsItem]?
    /// Patch mode: principals whose grants should be removed from the existing list. Cannot be combined with `grants`.
    public var remove: [SolutionInstallInputAclRemoveItem]?

    public init(
        add: [SolutionInstallInputAclAddItem]? = nil,
        grants: [SolutionInstallInputAclGrantsItem]? = nil,
        remove: [SolutionInstallInputAclRemoveItem]? = nil
    ) {
        self.add = add
        self.grants = grants
        self.remove = remove
...
public struct SolutionInstallInputDetailsPrefills: Codable, Sendable {
...
public struct SolutionInstallInputDetails: Codable, Sendable {
    ...
    public var prefills: SolutionInstallInputDetailsPrefills?
    /// Install-details discriminator. Always `automation` for this variant.
    public var type: String

    public init(prefills: SolutionInstallInputDetailsPrefills? = nil, type: String) {
...
public struct SolutionInstallInput: Codable, Sendable {
    ...
    public var acl: SolutionInstallInputAcl?
    ...
    public init(
        acl: SolutionInstallInputAcl? = nil,
        allowAutoImport: Bool? = nil,
        details: SolutionInstallInputDetails? = nil,
        installInputs: [String: JSONValue]? = nil,
        ...
        self.installInputs = installInputs
        self.lookupKey = lookupKey
        self.lookupKeySuffix = lookupKeySuffix
        self.name = name
        self.org = org
    ...
    private enum CodingKeys: String, CodingKey {
        ...
        case details
        case installInputs = "install_inputs"
        case lookupKey = "lookup_key"
        case lookupKeySuffix = "lookup_key_suffix"
        case name
        case org
...
public struct SolutionViewInput: Codable, Sendable {
    ...
    public init(anonymous: String? = nil) {
...
public final class SolutionResource: Sendable {
    ...
    public func image(solution: String, token: String, v: String? = nil, file: String? = nil) async throws -> RawResponse {
        var query: [(String, String)] = []
        ...
        return try await http.requestRaw("/api/v1/solutions/\(solution)/image", query: query)
    }
    ...
    public func reconcileProductKnowledge(solution: String) async throws -> ProductKnowledgeReconcileResponse {
        return try await http.request("/api/v1/solutions/\(solution)/reconcile_product_knowledge", method: "POST")
    }
    ...
    public func view(solution: String, input: SolutionViewInput) async throws {
        try await http.requestVoid("/api/v1/solutions/\(solution)/view", method: "POST", body: input)
    }
}

...
public struct AgentWorkingMemoryUpdateInput: Codable, Sendable {
    ...
    public init(expiresAt: Date? = nil, value: String? = nil) {
...
public struct AgentWorkItemClaimInput: Codable, Sendable {
...
public struct AgentAgentRoutinesInputMessagePolicy: Codable, Sendable {
...
public struct AgentAgentRoutinesInput: Codable, Sendable {
    ...
    public var messagePolicy: AgentAgentRoutinesInputMessagePolicy?
    ...
    public init(
        ...
        handlerType: String,
        lookupKey: String? = nil,
        messagePolicy: AgentAgentRoutinesInputMessagePolicy? = nil,
        metadata: [String: JSONValue]? = nil,
        name: String,
...
public struct AgentThreadsInputThreadMembersItem: Codable, Sendable {
...
public struct AgentThreadsInputThreadProfilePicture: Codable, Sendable {
...
public struct AgentThreadsInputThreadSettings: Codable, Sendable {
...
public struct AgentThreadsInputThread: Codable, Sendable {
    ...
    public var members: [AgentThreadsInputThreadMembersItem]?
    ...
    public var profilePicture: AgentThreadsInputThreadProfilePicture?
    /// Configuration overrides for the thread, such as AI model selection and context window settings.
    public var settings: AgentThreadsInputThreadSettings?
    ...
    public init(
        ...
        key: String? = nil,
        kind: String? = nil,
        members: [AgentThreadsInputThreadMembersItem]? = nil,
        metadata: [String: JSONValue]? = nil,
        muted: Bool? = nil,
        orgId: String? = nil,
        profilePicture: AgentThreadsInputThreadProfilePicture? = nil,
        settings: AgentThreadsInputThreadSettings? = nil,
        slug: String? = nil,
        title: String? = nil,
...
public final class AgentWorkingMemoryResource: Sendable {
    private let http: HttpClient
    ...
    public func list(agent: String, page: Int? = nil, pageSize: Int? = nil, search: String? = nil) async throws -> WorkingMemoryEntryListResponse {
        var query: [(String, String)] = []
        if let page = page {
    ...
    public func delete(agent: String, entry: String) async throws {
        try await http.requestVoid("/api/v1/agents/\(agent)/agent_working_memory/\(entry)", method: "DELETE")
    }
    ...
    public func update(agent: String, entry: String, input: AgentWorkingMemoryUpdateInput) async throws -> WorkingMemoryEntry {
        return try await http.request("/api/v1/agents/\(agent)/agent_working_memory/\(entry)", method: "PATCH", body: input)
    }
}
...
public final class AgentWorkItemResource: Sendable {
    private let http: HttpClient
    ...
    /// - Returns: Successful response
    public func list(agent: String, execution: String? = nil, limit: Int? = nil, afterCursor: String? = nil) async throws -> WorkflowWorkItemList {
        var query: [(String, String)] = []
        ...
        return try await http.request("/api/v1/agents/\(agent)/work_items", query: query)
    }
    ...
    ///   - input: Request body.
    /// - Returns: Successful response
    public func claim(agent: String, input: AgentWorkItemClaimInput) async throws -> WorkflowWorkItemClaim {
        return try await http.request("/api/v1/agents/\(agent)/work_items/claim", method: "POST", body: input)
    }
}
...
public final class AgentResource: Sendable {
    ...
    public let agentWorkingMemory: AgentWorkingMemoryResource
    public let schedules: ScheduleResource
    public let workItems: AgentWorkItemResource
    ...
    public init(http: HttpClient) {
        ...
        self.agentWorkingMemory = AgentWorkingMemoryResource(http: http)
        self.schedules = ScheduleResource(http: http)
        self.workItems = AgentWorkItemResource(http: http)
    }

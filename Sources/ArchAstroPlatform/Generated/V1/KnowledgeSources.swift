...
public struct KnowledgeSourceSearchInput: Codable, Sendable {
...
public struct KnowledgeSourceSearchResponseDataItem: Codable, Sendable {
    /// Normalized plain-text content of the matched chunk.
    public var content: String?
    /// MIME type of the content, e.g. `"text/plain"` or `"text/html"`.
    public var contentType: String?
    /// When this item was indexed into the knowledge base (ISO 8601).
    public var createdAt: Date?
    /// Context item ID (`cim_...`).
    public var id: String
    /// Result variant discriminator. Always `"chunk"` for this object type.
    public var kind: String
    /// Arbitrary key-value metadata attached to this item by the source connector.
    public var metadata: [String: JSONValue]?
    /// Raw content payload as stored by the source connector, before normalization.
    public var rawContent: [String: JSONValue]?
    /// Type identifier of the parent knowledge source (e.g. `"gmail"`, `"github_activity"`). Returns `"unknown"` when the source association is not loaded.
    public var type: String?
    ...
    public init(
        ...
        kind: String,
        metadata: [String: JSONValue]? = nil,
        rawContent: [String: JSONValue]? = nil,
        type: String? = nil
    ) {
        self.content = content
        self.contentType = contentType
...
/// Successful response
public struct KnowledgeSourceSearchResponse: Codable, Sendable {
    /// Array of matching knowledge items ordered by relevance score descending.
    public var data: [KnowledgeSourceSearchResponseDataItem]

    public init(data: [KnowledgeSourceSearchResponseDataItem]) {
        self.data = data
    }
...
public final class KnowledgeSourceResource: Sendable {
    ...
    public func list(page: Int? = nil, pageSize: Int? = nil, search: String? = nil, type: String? = nil, team: [String]? = nil, thread: [String]? = nil, installation: String? = nil, agent: String? = nil, org: String? = nil, ownerScope: String? = nil) async throws -> KnowledgeSourceListResponse {
    ...
    ///   - input: Request body.
    /// - Returns: Successful response
    public func search(source: String, input: KnowledgeSourceSearchInput) async throws -> KnowledgeSourceSearchResponse {
        return try await http.request("/api/v1/knowledge_sources/\(source)/search", method: "POST", body: input)
    }
}

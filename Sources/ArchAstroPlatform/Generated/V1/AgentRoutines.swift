...
public struct AgentRoutineUpdateInputMessagePolicy: Codable, Sendable {
...
public struct AgentRoutineUpdateInput: Codable, Sendable {
    ...
    public var messagePolicy: AgentRoutineUpdateInputMessagePolicy?
    ...
    public init(
        ...
        messagePolicy: AgentRoutineUpdateInputMessagePolicy? = nil,
...
public struct AgentRoutineInvokeInputDelivery: Codable, Sendable {
    ...
    public init(message: String? = nil, thread: String? = nil, type: String) {
...
public struct AgentRoutineInvokeInput: Codable, Sendable {
    ...
    public var delivery: AgentRoutineInvokeInputDelivery?
    ...
    public init(
        delivery: AgentRoutineInvokeInputDelivery? = nil,
...
public final class AgentRoutineRunResource2: Sendable {
    ...
    public func journal(run: String, limit: Int? = nil, afterCursor: String? = nil) async throws -> RunJournalPage {
        ...
        return try await http.request("/api/v1/agent_routines/runs/\(run)/journal", query: query)
    }
}

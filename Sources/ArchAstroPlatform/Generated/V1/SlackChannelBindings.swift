...
public struct SlackChannelBindingAssignInput: Codable, Sendable {
    ...
    public init(agentUserId: String, channelId: String, slackTeamId: String) {
...
public final class SlackChannelBindingResource: Sendable {
    ...
    public func assign(input: SlackChannelBindingAssignInput) async throws -> SlackChannelBinding {
        return try await http.request("/api/v1/slack_channel_bindings/assign", method: "POST", body: input)
    }

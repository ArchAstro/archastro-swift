...
public struct UserProfileInput: Codable, Sendable {
    ...
    public init(
        alias: String? = nil,
        clearFullName: Bool? = nil,
        clearProfilePicture: Bool? = nil,
        fullName: String?? = nil,
        metadata: [String: JSONValue]? = nil,
        profilePicture: UserProfileInputProfilePicture?? = nil
    ) {
        self.alias = alias
        self.clearFullName = clearFullName
        self.clearProfilePicture = clearProfilePicture
    ...
    private enum CodingKeys: String, CodingKey {
        case alias
        case clearFullName = "clear_full_name"
        case clearProfilePicture = "clear_profile_picture"
...
/// Successful response
public struct IntegrationAccessTokenResponse: Codable, Sendable {
    /// GitHub access token. Treat this value as a secret.
    public var accessToken: String
    /// Access-token expiry, or null for non-expiring tokens.
    public var expiresAt: Date?
    /// Integration ID (`int_...`).
    public var integration: String
    /// Always `github`.
    public var provider: String
    /// Recorded GitHub OAuth scopes.
    public var scopes: [String]
    /// Credential authority model: `oauth` or `github_app_user`.
    public var tokenKind: String
    /// GitHub login associated with the credential.
...
public struct UserSshKeyListResponseDataItem: Codable, Sendable {
...
/// Successful response
public struct UserSshKeyListResponse: Codable, Sendable {
    public var afterCursor: String??
    public var beforeCursor: String??
    public var data: [UserSshKeyListResponseDataItem]
    public var hasMore: Bool

    public init(
        afterCursor: String?? = nil,
        beforeCursor: String?? = nil,
        data: [UserSshKeyListResponseDataItem],
        hasMore: Bool
    ) {
...
public struct UserThreadListResponseDataItemParentMessageContextItem: Codable, Sendable {
...
public struct UserThreadListResponseDataItemParentMessage: Codable, Sendable {
    ...
    public var context: [UserThreadListResponseDataItemParentMessageContextItem]?
    ...
    public init(
        ...
        content: String?? = nil,
        context: [UserThreadListResponseDataItemParentMessageContextItem]? = nil,
...
public struct UserOrgsResponseDataItem: Codable, Sendable {
    ...
    /// Owner user ID for a personal org. `null` for company orgs.
    public var ownerUser: String?
...
public final class IntegrationResource: Sendable {
    ...
    public func accessToken(user: String, provider: String) async throws -> IntegrationAccessTokenResponse {
        return try await http.request("/api/v1/users/\(user)/integrations/\(provider)/access_token")
    }
}

public final class UserSshKeyResource: Sendable {
    private let http: HttpClient
    ...
    ///   - afterCursor: Opaque cursor for the next page of older keys.
    /// - Returns: Successful response
    public func list(user: String, limit: Int? = nil, afterCursor: String? = nil) async throws -> UserSshKeyListResponse {
        ...
        return try await http.request("/api/v1/users/\(user)/ssh_keys", query: query)
    }
    ...
    public func create(user: String, input: UserSshKeyCreateInput) async throws -> UserSSHKey {
        return try await http.request("/api/v1/users/\(user)/ssh_keys", method: "POST", body: input)
    }
}
...
public final class UserResource: Sendable {
    private let http: HttpClient
    public let integrations: IntegrationResource
    public let sshKeys: UserSshKeyResource
    ...
    public init(http: HttpClient) {
        self.http = http
        self.integrations = IntegrationResource(http: http)
        self.sshKeys = UserSshKeyResource(http: http)
    ...
    public func me(entitlement: [String]? = nil) async throws -> CurrentUser {
        var query: [(String, String)] = []
        if let entitlement = entitlement {
            for item in entitlement {
                query.append(("entitlement", item))
            }
        }
        return try await http.request("/api/v1/users/me", query: query)
    }
    ...
    /// - Returns: Successful response
    public func artifacts(user: String, groupKey: String? = nil, groupKeyPrefix: String? = nil) async throws -> UserArtifactsResponse {
        var query: [(String, String)] = []
        ...
        return try await http.request("/api/v1/users/\(user)/artifacts", query: query)
    }

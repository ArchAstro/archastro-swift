...
// Content hash: 8a19b1a9937c

import Foundation

public struct StreamCreateInputMessagesItemToolCallsItem: Codable, Sendable {
...
public struct StreamCreateInputMessagesItemToolResultsItem: Codable, Sendable {
...
public struct StreamCreateInputMessagesItem: Codable, Sendable {
    ...
    public var toolCalls: [StreamCreateInputMessagesItemToolCallsItem]?
    ...
    public var toolResults: [StreamCreateInputMessagesItemToolResultsItem]?
    ...
    public init(
        ...
        toolCalls: [StreamCreateInputMessagesItemToolCallsItem]? = nil,
        toolResults: [StreamCreateInputMessagesItemToolResultsItem]? = nil
    ) {
        self.content = content
...
public struct StreamCreateInputOptsToolsItemFunction: Codable, Sendable {
...
public struct StreamCreateInputOptsToolsItem: Codable, Sendable {
    /// Callable function this tool exposes, including its name, description, and parameter schema.
    public var function: StreamCreateInputOptsToolsItemFunction
    /// The tool type. Currently always `"function"`.
    public var type: String

    public init(function: StreamCreateInputOptsToolsItemFunction, type: String) {
...
public struct StreamCreateInputOpts: Codable, Sendable {
    ...
    public var tools: [StreamCreateInputOptsToolsItem]?
    ...
    public init(
        ...
        tools: [StreamCreateInputOptsToolsItem]? = nil
    ) {
...
public struct StreamCreateInput: Codable, Sendable {
    ...
    public var messages: [StreamCreateInputMessagesItem]
    /// Model and sampling configuration for this request.
    public var opts: StreamCreateInputOpts
    ...
    public init(
        attribution: [String: JSONValue]? = nil,
        context: [String: JSONValue]? = nil,
        messages: [StreamCreateInputMessagesItem],
        opts: StreamCreateInputOpts,
...
public struct EvaluationEvaluationsInput: Codable, Sendable {
...
public struct AiSessionTokenInput: Codable, Sendable {
    public var entitlement: String?
    public var restrictions: [String: JSONValue]?
    public var ttl: Int?
    public var userId: String

    public init(
        entitlement: String? = nil,
        restrictions: [String: JSONValue]? = nil,
        ttl: Int? = nil,
        userId: String
    ) {
...
public struct ChatModelsResponseDataItem: Codable, Sendable {
    /// Machine-readable model capabilities. `"image"` marks image-input chat, `"search"` marks built-in web search, `"temperature"` marks models that accept the temperature generation parameter, and `"thinking"` marks models with configurable reasoning. Empty when the catalog entry declares no special capabilities.
...
/// Successful response
public struct EmbeddingSimilarityComparisonResponse: Codable, Sendable {
    /// Configured default embedding model key used for both texts.
    public var model: String
    /// Cosine similarity from `-1.0` to `1.0`, computed as `1 - cosine_distance`.
    public var similarityScore: Double

    public init(model: String, similarityScore: Double) {
        self.model = model
...
public struct EvaluationModelsResponseDataItem: Codable, Sendable {
    /// Machine-readable model capabilities. `"image"` marks image-input chat, `"search"` marks built-in web search, `"temperature"` marks models that accept the temperature generation parameter, and `"thinking"` marks models with configurable reasoning. Empty when the catalog entry declares no special capabilities.
    public var capabilities: [String]
    /// Maximum context-window size in tokens this model accepts, when the platform publishes it. Use it to size prompt/history against the real window rather than a hardcoded default. `null` for entries whose window the platform does not report (e.g. legacy or mock model listings); clients should apply a conservative fallback in that case.
    public var contextWindow: Int??
...
/// Successful response
public struct EvaluationModelsResponse: Codable, Sendable {
    /// Array of available evaluation model objects. At least one entry is always present.
    public var data: [EvaluationModelsResponseDataItem]

    public init(data: [EvaluationModelsResponseDataItem]) {
        self.data = data
    }
...
/// Successful response
public struct AiSessionTokenResponse: Codable, Sendable {
...
public final class StreamResource: Sendable {
    ...
    public func create(input: StreamCreateInput) -> AsyncThrowingStream<SSEEvent, any Error> {
...
public final class CompletionResource: Sendable {
    private let http: HttpClient
    public let stream: StreamResource

    public init(http: HttpClient) {
        self.http = http
        self.stream = StreamResource(http: http)
    }
...
public final class EmbeddingResource: Sendable {
    private let http: HttpClient
    ...
    ///   - input: Request body.
    /// - Returns: Successful response
    public func similarityComparison(input: EmbeddingSimilarityComparisonInput) async throws -> EmbeddingSimilarityComparisonResponse {
        return try await http.request("/api/v1/ai/embedding/similarity_comparison", method: "POST", body: input)
    }
}

public final class EvaluationResource: Sendable {
    private let http: HttpClient
    ...
    public func evaluations(input: EvaluationEvaluationsInput) async throws -> AIEvaluationResult {
        return try await http.request("/api/v1/ai/evaluation/evaluations", method: "POST", body: input)
    }
    ...
    ///
    /// - Returns: Successful response
    public func models() async throws -> EvaluationModelsResponse {
        return try await http.request("/api/v1/ai/evaluation/models")
    }
}
...
public final class AiResource: Sendable {
    ...
    public let embedding: EmbeddingResource
    public let evaluation: EvaluationResource
    public let image: ImageResource

    public init(http: HttpClient) {
        self.http = http
        self.chat = ChatResource(http: http)
        self.embedding = EmbeddingResource(http: http)
        self.evaluation = EvaluationResource(http: http)
    ...
    ///   - input: Request body.
    /// - Returns: Successful response
    public func sessionToken(input: AiSessionTokenInput) async throws -> AiSessionTokenResponse {
        return try await http.request("/api/v1/ai/session_token", method: "POST", body: input)
    }
}

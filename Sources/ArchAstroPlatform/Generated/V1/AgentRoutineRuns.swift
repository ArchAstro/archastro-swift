...
public final class AgentRoutineRunResource: Sendable {
    ...
    ///
    /// - Parameters:
    ///   - agentRoutineRun: ID of the agent routine run to stream status updates for.
    /// - Returns: Server-Sent Events stream
    public func stream(agentRoutineRun: String) -> AsyncThrowingStream<SSEEvent, any Error> {
        return http.streamSSE("/api/v1/agent_routine_runs/\(agentRoutineRun)/stream")
    }
}

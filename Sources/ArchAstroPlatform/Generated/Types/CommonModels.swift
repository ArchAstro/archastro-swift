...
public struct MessagePolicy: Codable, Sendable {
    ...
    public init(recipients: [String]? = nil, visibility: String? = nil) {
...
public struct Setup: Codable, Sendable {
    ...
    public init(nextAction: String, protocolStatus: String, reason: String) {
    ...
    private enum CodingKeys: String, CodingKey {
        ...
        case protocolStatus = "protocol_status"
        case reason
    }
}
...
public struct AuthTokens: Codable, Sendable {
    ...
    public var accountCreated: Bool
...
public struct Cancelled: Codable, Sendable {
    public var callId: String
    public var reason: String
    public var status: String

    public init(callId: String, reason: String, status: String) {
        self.callId = callId
        self.reason = reason
        self.status = status
    }
...
public struct MessageContext: Codable, Sendable {
...
public struct Ok: Codable, Sendable {
    ...
    public init(callId: String, content: String, status: String) {
        self.callId = callId
        self.content = content
        self.status = status
    }
...
public struct Command: Codable, Sendable {
    ...
    public var successOutput: [String: JSONValue]?

    public init(
        description: String,
        errorOutput: [String: JSONValue]? = nil,
        expectedInput: [String: JSONValue]? = nil,
        id: String,
        name: String,
        successOutput: [String: JSONValue]? = nil
    ) {
        self.description = description
...
public struct CreatedPrivateServiceEnrollment: Codable, Sendable {
    ...
    public var enrollmentTokenExpiresAt: Date
    ...
    public init(
        ...
        self.enrollmentTokenExpiresAt = enrollmentTokenExpiresAt
    ...
    private enum CodingKeys: String, CodingKey {
        ...
        case enrollmentTokenExpiresAt = "enrollment_token_expires_at"
        case generation
        case id
...
public struct EffectiveAccessBillingTrial: Codable, Sendable {
    ...
    public var paymentMethodStored: Bool
    /// Catalog plan whose trial is active.
    public var plan: String

    public init(endsAt: Date, paymentMethodStored: Bool, plan: String) {
        self.endsAt = endsAt
        self.paymentMethodStored = paymentMethodStored
        self.plan = plan
    }

    private enum CodingKeys: String, CodingKey {
        case endsAt = "ends_at"
        case paymentMethodStored = "payment_method_stored"
        case plan
    }
}

/// Billing authority and relevant active trials for one Viewer-derived principal kind.
public struct EffectiveAccessBillingPrincipal: Codable, Sendable {
    ...
    public var trials: [EffectiveAccessBillingTrial]

    public init(administrator: Bool, principalType: String, trials: [EffectiveAccessBillingTrial]) {
...
public struct EffectiveAccessEntitlement: Codable, Sendable {
...
public struct CurrentUser: Codable, Sendable {
    ...
    public init(
        ...
        app: String?? = nil,
        appName: String?? = nil,
        effectiveAccess: EffectiveAccess? = nil,
        email: String?? = nil,
        id: String,
        isSystemUser: Bool,
        metadata: [String: JSONValue]? = nil,
        name: String?? = nil,
        notificationSettings: [String: JSONValue],
        org: String?? = nil,
        orgKind: String?? = nil,
        orgName: String?? = nil,
        orgRole: String?? = nil,
...
public struct CustomObjectJoinResponse: Codable, Sendable {
...
public struct CustomObjectPresenceAck: Codable, Sendable {
...
public struct CustomObjectSaveResponse: Codable, Sendable {
...
public struct CustomObjectUpdateFieldsResponse: Codable, Sendable {
    ...
    public init(fields: [String: JSONValue], id: String, operationId: String) {
        self.fields = fields
        self.id = id
...
public struct D1Database: Codable, Sendable {
    /// Provider-assigned object identifier.
    public var id: String
    public var jurisdiction: String?
    public var name: String
    public var readReplication: [String: JSONValue]?
    public var type: String
    ...
    public init(
        ...
        name: String,
        readReplication: [String: JSONValue]? = nil,
        type: String
    ) {
        self.id = id
        self.jurisdiction = jurisdiction
        self.name = name
        self.readReplication = readReplication
        self.type = type
    }
...
public struct R2Bucket: Codable, Sendable {
    /// Provider-assigned object identifier.
    public var id: String
...
public enum Details: Codable, Sendable {
    case r2Bucket(R2Bucket)
    case d1Database(D1Database)

    public init(from decoder: any Decoder) throws {
        let raw = try JSONValue(from: decoder)
        let tag = raw["type"]?.stringValue
        switch tag {
            case "d1_database": self = .d1Database(try raw.decode(D1Database.self))
            case "r2_bucket": self = .r2Bucket(try raw.decode(R2Bucket.self))
            default:
    ...
    public func encode(to encoder: any Encoder) throws {
        switch self {
            case .r2Bucket(let value): try value.encode(to: encoder)
            case .d1Database(let value): try value.encode(to: encoder)
        }
    }
}

/// A domain event with stable attribution fields and an event-specific payload.
public struct DomainEvent: Codable, Sendable {
    public var agent: String?
    public var createdAt: Date
...
public struct ExternalObject: Codable, Sendable {
    public var agent: String?
    public var createdAt: Date
...
public struct NodeField: Codable, Sendable {
    /// Whether the field accepts expressions
    public var allowExpression: Bool?
...
public struct NodeType: Codable, Sendable {
...
public struct PrivateServiceFunction: Codable, Sendable {
...
public struct PrivateService: Codable, Sendable {
    /// Sorted callable definitions exposed by this private service.
    public var functions: [PrivateServiceFunction]
    /// Private service ID (`pvs_...`).
    public var id: String

    public init(functions: [PrivateServiceFunction], id: String) {
...
public struct PrivateServiceEnrollment: Codable, Sendable {
    ...
    public init(generation: Int, id: String, privateService: String) {
        self.generation = generation
        self.id = id
        self.privateService = privateService
    }
...
public struct PrivateServiceEnrollmentPage: Codable, Sendable {
    public var data: [PrivateServiceEnrollment]
    public var hasNext: Bool
    public var hasPrev: Bool
    public var page: Int
    public var pageSize: Int
...
public struct PrivateServicePage: Codable, Sendable {
    public var data: [PrivateService]
    public var hasNext: Bool
    public var hasPrev: Bool
    public var page: Int
    public var pageSize: Int
...
public struct ProductKnowledgeReconcileFailure: Codable, Sendable {
    ...
    public init(customerKey: String, error: String, retryable: Bool) {
...
public struct ProductKnowledgeReconcileResponse: Codable, Sendable {
    ...
    public var failures: [ProductKnowledgeReconcileFailure]
    /// Customer keys whose agent tool config is converged.
    public var reconciledCustomers: [String]

    public init(
        complete: Bool,
        failures: [ProductKnowledgeReconcileFailure],
        reconciledCustomers: [String]
    ) {
        self.complete = complete
        self.failures = failures
        self.reconciledCustomers = reconciledCustomers
    }

    private enum CodingKeys: String, CodingKey {
        case complete
        case failures
        case reconciledCustomers = "reconciled_customers"
    }
}
...
public struct RunJournalPage: Codable, Sendable {
    ...
    public var data: [WorkflowJournalEntry]
...
public struct RuntimeCapability: Codable, Sendable {
...
public struct RuntimeEnvVar: Codable, Sendable {
    ...
    public init(description: String? = nil, key: String, source: String) {
        self.description = description
        self.key = key
        self.source = source
    }
...
public struct RuntimeEnvVarList: Codable, Sendable {
    /// Array of runtime environment variable objects available in the current script execution context.
    public var data: [RuntimeEnvVar]

    public init(data: [RuntimeEnvVar]) {
        self.data = data
    }
...
public struct SandboxKey: Codable, Sendable {
...
public struct SlackChannelBinding: Codable, Sendable {
    ...
    public var depositThread: String?
    ...
    public var disclosureState: String?
    ...
    public var vendorAdminChannelAccess: String?

    public init(
        agents: [String]? = nil,
        allowBotConversations: Bool,
        channel: String? = nil,
        customerLabel: String? = nil,
        depositThread: String? = nil,
        disclosureState: String? = nil,
        id: String,
        ...
        replyStyle: String,
        residentAgent: String? = nil,
        routeKind: String,
        scopeKey: String? = nil,
        team: String? = nil,
        vendorAdminChannelAccess: String? = nil
    ) {
        self.agents = agents
        self.allowBotConversations = allowBotConversations
        self.channel = channel
        self.customerLabel = customerLabel
        self.depositThread = depositThread
        ...
        self.residentAgent = residentAgent
        self.routeKind = routeKind
        self.scopeKey = scopeKey
        self.team = team
        self.vendorAdminChannelAccess = vendorAdminChannelAccess
    }
    ...
    private enum CodingKeys: String, CodingKey {
        ...
        case depositThread = "deposit_thread"
        case disclosureState = "disclosure_state"
        case id
        case integration
        ...
        case replyStyle = "reply_style"
        case residentAgent = "resident_agent"
        case routeKind = "route_kind"
        case scopeKey = "scope_key"
        case team
        case vendorAdminChannelAccess = "vendor_admin_channel_access"
    }
}
...
public struct SlackDeliveryOutcome: Codable, Sendable {
    ...
    public init(
        ...
        guardKind: String? = nil,
        guardLabels: [String]? = nil,
        id: String,
        message: String? = nil,
        operation: String,
        outcome: String,
    ...
    private enum CodingKeys: String, CodingKey {
        ...
        case guardKind = "guard_kind"
        case guardLabels = "guard_labels"
        case id
        case message
        case operation
        case outcome
...
public struct SlackDeliveryOutcomeListResponse: Codable, Sendable {
    ...
    public var data: [SlackDeliveryOutcome]
...
public struct Trajectory: Codable, Sendable {
    ...
    public var messages: [[String: JSONValue]]?
...
public struct SolutionAutomationInvokeContract: Codable, Sendable {
    ...
    public var participants: [AutomationParticipantSlot]??
    ...
    public var prefills: AutomationPrefills

    public init(
        inputSchema: [String: JSONValue]?? = nil,
        participants: [AutomationParticipantSlot]?? = nil,
...
public struct SolutionAutomationTemplateDetails: Codable, Sendable {
    ...
    public var invokeContract: SolutionAutomationInvokeContract??
    /// Template-details discriminator. Always `automation` for this variant.
    public var type: String

    public init(
        automationType: String?? = nil,
        invokeContract: SolutionAutomationInvokeContract?? = nil,
        type: String
    ) {
...
public enum SolutionTemplateDetails: Codable, Sendable {
    case solutionAutomationTemplateDetails(SolutionAutomationTemplateDetails)

    public init(from decoder: any Decoder) throws {
        let raw = try JSONValue(from: decoder)
        let tag = raw["type"]?.stringValue
        switch tag {
            case "automation": self = .solutionAutomationTemplateDetails(try raw.decode(SolutionAutomationTemplateDetails.self))
            default:
                throw DecodingError.dataCorrupted(.init(codingPath: decoder.codingPath, debugDescription: "Unknown type tag: \(tag ?? "nil")"))
        }
    }
    ...
    public func encode(to encoder: any Encoder) throws {
        switch self {
            case .solutionAutomationTemplateDetails(let value): try value.encode(to: encoder)
        }
    }
}
...
public struct SolutionTemplateSummary: Codable, Sendable {
    ...
    public var details: SolutionTemplateDetails??
    ...
    public init(
        description: String?? = nil,
        details: SolutionTemplateDetails?? = nil,
        displayName: String?? = nil,
        id: String?? = nil,
        kind: String,
        lookupKey: String?? = nil,
...
public struct AgentSourceSolution: Codable, Sendable {
    ...
    public var currentSolution: SolutionSummary?
    ...
    public init(
        currentSolution: SolutionSummary? = nil,
...
public struct AgentRoutine: Codable, Sendable {
    ...
    public var messagePolicy: MessagePolicy?
    ...
    public init(
        ...
        lastAppliedTemplateConfig: String? = nil,
        lookupKey: String? = nil,
        messagePolicy: MessagePolicy? = nil,
        metadata: [String: JSONValue]? = nil,
        name: String? = nil,
    ...
    private enum CodingKeys: String, CodingKey {
        ...
        case lastAppliedTemplateConfig = "last_applied_template_config"
        case lookupKey = "lookup_key"
        case messagePolicy = "message_policy"
        case metadata
        case name
...
public struct AgentRoutineRunDelivery: Codable, Sendable {
    ...
    public init(
        ...
        self.deliveredMessage = deliveredMessage
...
public struct AgentRoutineRun: Codable, Sendable {
    ...
    public var delivery: AgentRoutineRunDelivery?
    ...
    public init(
        ...
        app: String? = nil,
        createdAt: Date? = nil,
        delivery: AgentRoutineRunDelivery? = nil,
        durationMs: Int? = nil,
        eventId: String? = nil,
        id: String,
        metadata: [String: JSONValue]? = nil,
...
public struct SolutionImportWarning: Codable, Sendable {
...
public struct SolutionImportResult: Codable, Sendable {
    ...
    public var warnings: [SolutionImportWarning]?
    ...
    public init(
        ...
        warnings: [SolutionImportWarning]? = nil
    ) {
        self.code = code
        self.dryRun = dryRun
...
public struct SolutionInstallResponseWebhook: Codable, Sendable {
    public var signingSecret: String
    public var url: String

    public init(signingSecret: String, url: String) {
...
public struct SolutionInstallResponse: Codable, Sendable {
    ...
    /// One-time connection details for a webhook-auth Automation install.
    public var webhook: SolutionInstallResponseWebhook?
    ...
    public init(
        ...
        lookupKey: String?? = nil,
        solution: String,
        webhook: SolutionInstallResponseWebhook? = nil
    ) {
        self.id = id
        self.kind = kind
        self.lookupKey = lookupKey
...
public struct SolutionInstance: Codable, Sendable {
    ...
    public var attachmentRef: [String: JSONValue]??
    ...
    public init(
        ...
        attachmentRef: [String: JSONValue]?? = nil,
        createdAt: Date,
        customerKey: String,
        customerLabel: String?? = nil,
        id: String,
        localEditCount: Int?? = nil,
        pinnedTemplateVersion: String?? = nil,
        pinnedVersionNumber: Int?? = nil,
        solutionTemplateConfig: String,
        status: String,
        updatedAt: Date
    ) {
        self.agent = agent
        ...
        self.pinnedTemplateVersion = pinnedTemplateVersion
        self.pinnedVersionNumber = pinnedVersionNumber
        self.solutionTemplateConfig = solutionTemplateConfig
        self.status = status
        self.updatedAt = updatedAt
    }
    ...
    private enum CodingKeys: String, CodingKey {
        ...
        case customerLabel = "customer_label"
        case id
        case localEditCount = "local_edit_count"
        case pinnedTemplateVersion = "pinned_template_version"
        case pinnedVersionNumber = "pinned_version_number"
        case solutionTemplateConfig = "solution_template_config"
        case status
        case updatedAt = "updated_at"
    }
}
...
public struct SolutionInstanceListResponse: Codable, Sendable {
    ...
    public var data: [SolutionInstance]

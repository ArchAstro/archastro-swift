...
public struct ChatLocalToolCall: Codable, Sendable {
...
public struct ChatLocalToolFunction: Codable, Sendable {
...
public struct ChatLocalToolDefinition: Codable, Sendable {
    public var function: ChatLocalToolFunction
    public var type: String

    public init(function: ChatLocalToolFunction, type: String) {
...
public struct ChatLocalToolProvider: Codable, Sendable {
    public var generation: Int
    public var providerId: String

    public init(generation: Int, providerId: String) {
...
public struct ChatLocalToolRequest: Codable, Sendable {
    public var calls: [ChatLocalToolCall]
    public var id: String

    public init(calls: [ChatLocalToolCall], id: String) {
        self.calls = calls
        self.id = id
    }
...
public struct ChatLocalToolResultError: Codable, Sendable {
    public var callId: String
    public var code: String
    public var message: String
    public var status: String

    public init(callId: String, code: String, message: String, status: String) {
        self.callId = callId
        self.code = code
...
public enum ChatLocalToolResult: Codable, Sendable {
    case ok(Ok)
    case chatLocalToolResultError(ChatLocalToolResultError)
    case cancelled(Cancelled)

    public init(from decoder: any Decoder) throws {
        let raw = try JSONValue(from: decoder)
        let tag = raw["status"]?.stringValue
        switch tag {
            case "cancelled": self = .cancelled(try raw.decode(Cancelled.self))
            case "error": self = .chatLocalToolResultError(try raw.decode(ChatLocalToolResultError.self))
            case "ok": self = .ok(try raw.decode(Ok.self))
            default:
                throw DecodingError.dataCorrupted(.init(codingPath: decoder.codingPath, debugDescription: "Unknown status tag: \(tag ?? "nil")"))
        }
    }
    ...
    public func encode(to encoder: any Encoder) throws {
        switch self {
            ...
            case .chatLocalToolResultError(let value): try value.encode(to: encoder)

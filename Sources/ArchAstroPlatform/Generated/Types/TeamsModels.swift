...
public struct TeamDeleteImpactResponse: Codable, Sendable {
    /// All custom-object rows owned by the Team, including soft-deleted rows.
    public var customObjectCount: Int
    /// Whether Team deletion physically deletes these rows; no restore is provided.
    public var customObjectsPhysicallyDeleted: Bool

    public init(customObjectCount: Int, customObjectsPhysicallyDeleted: Bool) {
        self.customObjectCount = customObjectCount
        self.customObjectsPhysicallyDeleted = customObjectsPhysicallyDeleted
    }

    private enum CodingKeys: String, CodingKey {
        case customObjectCount = "custom_object_count"
        case customObjectsPhysicallyDeleted = "custom_objects_physically_deleted"
    }
}
